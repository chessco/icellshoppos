...
-- CreateEnum
CREATE TYPE "ItemType" AS ENUM ('base', 'extra_seat');
...
CREATE TABLE "Plan" (
    ...
    "extraSeatPriceCents" INTEGER NOT NULL,
...
CREATE TABLE "InventoryItem" (
    ...
    "costPesos" DECIMAL(12,2) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "InventoryItem_organizationId_imei_key" ON "InventoryItem"("organizationId", "imei");
